...
Subsequently, their research takes the estimates and aggregate them to the country level, weighting by population per capita as the dependent variable.
...
Furthermore, the authors argue that non-local pollution (traveling) will be the driving force of variation within the second equation because the non-local effects will be more likely to have similar effects as opposed to the local effects which are more susceptible to differ.
The effect of wind direction is confined by using bins.
The specification for the remaining control variables is X, again. 
This specification captures variation dependent on wind changes and their affect on local pollution.
