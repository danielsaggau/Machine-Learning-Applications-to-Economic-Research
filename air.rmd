...
Deryugina et al. (2019) use an instrumental variable approach.
...
Deryugina et al. (2019) account for fixed effects, climate variables, changes in country's daily wind direction,lag variables, various pollution scores and weather conditions.
...
Secondly, the authors argue that computational constraints make it impossible to include country, state-by month and month by year fixed effects in this regression. 
...
Here, Deryugina et al. (2019) focus on feature selection for the main features and estimates but not for the other control variables. 
