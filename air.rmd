...
We can see that there is a near 0 effect among 75 percent of our sample looking at elderly beneficiaries.
...
The authors also comparing propose estimates based on machine learning methods which allow us to enable feature selection.
...
Lastly, I will take about further measures to improve robustness and open questions. 
...
One should also note that one could should consider the difference between using generic machine learning methods versus e.g. a causal random forest. 
One can use a causal random forests for lower dimensional data focusing on the conditional average treatment effects. 
